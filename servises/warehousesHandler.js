...
module.exports.reduceQuantity = 0
...
class WarehousesHandler {
    ...
    _checkAllIngredients = (order, userIngredients, warehouses) => {
    ...
    checkQuantitiesOfIngredients = (order) => {
        ...
        if (isLackOfQuantities < 0) {
            ...
            return {
                ...
                message: `${order}: all ingredients was in on the warehouses: quantities reduced`
            }
        }
    }
    ...
    _checkDishIngredientsInWarehouse = (order, warehousesCopy) => {
        // const userIngredients = [];
        // this._checkAllIngredients(order, userIngredients, this.warehouses);
        //
