...
//         const userIngredients = ["Tomatoes", "Vinegar", "Chocolate"];
//         const sumArr = [];
//         expect(buyService.getSum(userIngredients, sumArr)).toBeDefined();
//         expect(buyService.getSum(userIngredients, sumArr)).not.toBeUndefined();
//     });
// });
...
//         const userIngredients = ["Tomatoes", "Vinegar", "Chocolate"];
//         expect(buyService.getAllergies(name, userIngredients)).toEqual(["Vinegar"]);
//     });
// });
